    ...
    if request.method == "POST":
        try:
            ...
            if serializer.is_valid():
                ...
                # Ensure 'from_phone_number' and 'twilio_client' are defined
                call = twilio_client.calls.create(
                    to=client_phone_number,
                    from_=from_phone_number,
                    url="wss://d92b-106-76-230-243.ngrok-free.app/ws/streams"
                )
                ...
                Call.objects.create(
                    ...
                    call_sid=call.sid,
                    assistant_id=data.get("assistant_id", 1),  # Default to 1 if not provided
                )
